...
* 韻鏡
** 東
|       | lung  |      | ghung  | hung   | qung  |      | sung  | zung    | chung   | cung   | ngung  |       | khung   | kung  |       | dung    | thung   | tung    | mung   | bung   |         |        |
|       |       |      |        |        |       |      |       | zriung  |         |        |        |       |         |       |       |         |         |         |        |        |         |        |
| njung | liung | jung | iung   |        |       |      |       |         | chjung  | cjung  | ngiung | giung | khiung  | kiung |       | driung  | thriung | triung  | miung  | biung  | phiung  | piung  |
|       |       | jung |        |        |       |      | siung |         |         |        |        |       |         |       |       |         |         |         |        |        |         |        |
|-------+-------+------+--------+--------+-------+------+-------+---------+---------+--------+--------+-------+---------+-------+-------+---------+---------+---------+--------+--------+---------+--------|
|       | lungx |      | ghungx | hungx  | qungx |      | sungx |         |         | cungx  |        |       | khungx  |       | nungx | dungx   | thungx  | tungx   | mungx  | bungx  |         | pungx  |
|       |       |      |        |        |       |      |       |         |         |        |        |       |         |       |       |         |         |         |        |        |         |        |
|       |       |      |        |        |       |      |       |         |         |        |        |       |         |       |       |         |         |         |        |        |         |        |
|       |       |      |        |        |       |      |       |         |         |        |        |       |         |       |       |         |         |         |        |        |         |        |
|-------+-------+------+--------+--------+-------+------+-------+---------+---------+--------+--------+-------+---------+-------+-------+---------+---------+---------+--------+--------+---------+--------|
|       | lungh |      | ghungh | hungh  | qungh |      | sungh | zungh   | chungh  | cungh  |        |       | khungh  | kungh | nungh | dungh   | thungh  | tungh   | mungh  | bungh  |         |        |
|       |       |      |        |        |       |      |       | zriungh |         |        |        |       |         |       |       |         |         |         |        |        |         |        |
|       |       |      |        | hiungh |       |      |       |         | chjungh | cjungh |        |       | khiungh |       |       | driungh |         | triungh | miungh | biungh | phiungh | piungh |
|       |       |      |        |        |       |      |       |         | chiungh |        |        |       |         |       |       |         |         |         |        |        |         |        |
|-------+-------+------+--------+--------+-------+------+-------+---------+---------+--------+--------+-------+---------+-------+-------+---------+---------+---------+--------+--------+---------+--------|
|       | luk   |      | ghuk   | huk    | quk   |      | suk   | zuk     | chuk    | cuk    |        |       | khuk    | kuk   |       | duk     | thuk    | tuk     | muk    | buk    | phuk    | puk    |
|       |       |      |        |        |       |      | sriuk |         | chriuk  | criuk  |        |       |         |       |       |         |         |         |        |        |         |        |
...
** 冬
|         | luung  |        | ghuung  |       |        |         | suung  | zuung  | chuung   | cuung   |        |        |         | kuung  | nuung   | duung   | thuung   | tuung   |        |        |         |        |
|         |        |        |         |       |        |         |        |        |          |         |        |        |         |        |         |         |          |         |        |        |         |        |
| njyung  | lyung  | jyung  |         | hyung | qyung  | zjyung  | sjyung |        | chjyung  | chyung  | ngyung | gyung  | khyung  | kyung  | nryung  | dryung  | thryung  |         |        | byung  | phyung  | pyung  |
|         |        | jyung  |         |       |        | zsyung  | syung  | zyung  | chyung   | cyung   |        |        |         |        |         |         |          |         |        |        |         |        |
|---------+--------+--------+---------+-------+--------+---------+--------+--------+----------+---------+--------+--------+---------+--------+---------+---------+----------+---------+--------+--------+---------+--------|
|         |        |        |         |       |        |         |        |        |          |         |        |        |         |        |         |         |          |         |        |        |         |        |
|         |        |        |         |       |        |         |        |        |          |         |        |        |         |        |         |         |          |         |        |        |         |        |
| njyungx | lyungx |        |         |       | qyungx | zjyungx |        |        | chjyungx | cjyungx |        | gyungx | khyungx | kyungx |         | dryungx | thryungx | tryungx |        | byungx | phyungx | pyungx |
|         |        | jyungx |         |       |        |         | syungx |        | chyungx  | cyungx  |        |        |         |        |         |         |          |         |        |        |         |        |
|---------+--------+--------+---------+-------+--------+---------+--------+--------+----------+---------+--------+--------+---------+--------+---------+---------+----------+---------+--------+--------+---------+--------|
|         |        |        | ghuungh |       |        |         | suungh |        |          | cuungh  |        |        |         |        |         |         | thuungh  | tuungh  | muungh |        |         |        |
|         |        |        |         |       |        |         |        |        |          |         |        |        |         |        |         |         |          |         |        |        |         |        |
| njyungh | lyungh |        |         |       |        |         |        |        |          | cjyungh |        | gyungh | khyungh | kyungh | nryungh | dryungh | thryungh |         |        | byungh |         | pyungh |
|         |        | jyungh |         |       |        | zsyungh |        | zyungh |          | cyungh  |        |        |         |        |         |         |          |         |        |        |         |        |
|---------+--------+--------+---------+-------+--------+---------+--------+--------+----------+---------+--------+--------+---------+--------+---------+---------+----------+---------+--------+--------+---------+--------|
|         | luuk   |        | ghuuk   | huuk  | quuk   |         | suuk   |        |          | cuuk    | nguuk  |        | khuuk   | kuuk   | nuuk    | duuk    |          | tuuk    | muuk   | buuk   | phuuk   | puuk   |
|         |        |        |         |       |        |         |        | zryuk  | chryuk   |         |        |        |         |        |         |         |          |         |        |        |         |        |
| njyuk   | lyuk   | jyuk   |         | hyuk  | qiuk   | zjyuk   | sjyuk  | zsjyuk | chjyuk   | cjyuk   | ngyuk  | gyuk   | khyuk   | kyuk   |         | dryuk   | thryuk   | tryuk   | myuk   | byuk   |         | pyuk   |
