...
| Q                 | W               | E             | R             | T                   | Y                    | U                 | I                | O           | P               |
| q 影              | ng 疑           | chj 昌        | th 透徹       | t 端知              | 云 j 以              | zsj 船            | zj 常            | sj 書       | p 幫            |
| ia 麻陽 A         | ia 戈嚴元陽廢 B | e 齊蕭添先青  | ue 齊先青     | ie 支宵鹽仙清祭 A   | y 幽脂諄 A           | u 侯冬東          | i 之脂侵真蒸 A   | o 模覃痕登  | uo 魂登 yo 虞 A |
| x                 | ngx             | mx            | nx            | t                   | ix                   | ux                |                  |             | p               |
|-------------------+-----------------+---------------+---------------+---------------------+----------------------+-------------------+------------------+-------------+-----------------|
| A                 | S               | D             | F             | G                   | H                    | J                 | K                | L           |                 |
| cj 章             | s 心生          | d 定澄        | ph 滂         | g 群 gh 匣          | h 曉                 | zj 邪俟           | k 見             | l 來        |                 |
| a 歌咍豪談寒唐泰  | ua 戈灰桓唐泰   | re 佳咸山耕   | rue 佳山耕    | ie 支宵鹽仙庚清祭 B | io 魚 A y 脂真諄蒸 B | io 魚微欣 B ru 江 | i 之脂侵真臻蒸 B | yo 虞微文 B |                 |
| -                 | ng              | m             | n             |                     | i                    | u                 | k                |             |                 |
|-------------------+-----------------+---------------+---------------+---------------------+----------------------+-------------------+------------------+-------------+-----------------|
| Z                 | X               | C             | V             | B                   | N                    | M                 |                  |             |                 |
| z 從              | kh 溪           | c 精莊        | ch 清初       | b 並                | n 泥娘日             | m 明              |                  |             |                 |
| ra 麻皆肴銜刪庚夬 | rua 麻皆刪庚夬  | ye 支仙清祭 A | ye 支仙庚祭 B | ya 戈凡元陽廢 B     | iu 尤東鍾 A          | iu 尤東鍾 B       |                  |             |                 |
| h                 | ngh             | mh            | nh            | d                   | ih                   | uh                |                  |             |                 |
* 韻鏡
...
|----+----------+---------+--------+----+---------+---------+----------+----------+-----------+-----------+----------+----------+---------+-----------+---------+----------+----------+-----------+----------+----+-----+----------+---------|
|    |          |         |        |    |         |         |          |          |           |           |          |          |         |           |         |          |          |           |          |    |     |          |         |
|    |          |         |        |    |         |         |          | srim 森  | zrim 岑   | chrim 嵾  | crim 簪  |          |         |           |         |          |          |           |          |    |     |          |         |
|    | njim 任  | lim 林  |        |    | him 歆  | qim 音  | zjim 諶  | sjim 深  | zsjim     | chjim     | cjim 斟  | ngim 吟  | gim 琴  | khim 欽   | kim 金  | nrim 您  | drim 沈  | thrim 琛  | trim 碪  |    |     |          |         |
| 侵 |          |         | jim 淫 |    |         | qjim 愔 | zsim 尋  | sim 心   | zim 埐    | chim 侵   | cim 祲   |          |         |           |         |          |          |           |          |    |     |          |         |
|----+----------+---------+--------+----+---------+---------+----------+----------+-----------+-----------+----------+----------+---------+-----------+---------+----------+----------+-----------+----------+----+-----+----------+---------|
|    |          |         |        |    |         |         |          |          |           |           |          |          |         |           |         |          |          |           |          |    |     |          |         |
|    |          |         |        |    |         |         |          | srimx 瘮 | zrimx     | chrimx 墋 | crimx 怎 |          |         |           |         |          |          |           |          |    |     |          |         |
|    | njimx 荏 | limx 廩 |        |    | himx 廞 | qimx 飲 | zjimx 甚 | sjimx 沈 | zsjimx 葚 | chjimx 瀋 | cjimx 枕 | ngimx 僸 | gimx 噤 | khimx 顉  | kimx 錦 | nrimx 拰 | drimx 朕 | thrimx 踸 | trimx 戡 |    |     | phimx 品 | pimx 稟 |
| 寢 |          |         |        |    |         |         |          | simx 罧  | zimx 蕈   | chimx 寢  | cimx     |          |         | khjimx 坅 |         |          |          |           |          |    |     |          |         |
|----+----------+---------+--------+----+---------+---------+----------+----------+-----------+-----------+----------+----------+---------+-----------+---------+----------+----------+-----------+----------+----+-----+----------+---------|
|    |          |         |        |    |         |         |          |          |           |           |          |          |         |           |         |          |          |           |          |    |     |          |         |
|    |          |         |        |    |         |         |          | srimh 滲 |           | chrimh 讖 | crimh 譖 |          |         |           |         |          |          |           |          |    |     |          |         |
|    | njimh 絍 | limh 臨 | imh    |    |         | qimh 蔭 | zjimh 甚 | sjimh 深 |           |           | cjimh 枕 | ngimh 吟 | gimh 紟 |           | kimh 禁 | nrimh 賃 | drimh 鴆 | thrimh 闖 | trimh 揕 |    |     |          |         |
| 沁 |          |         |        |    |         |         |          |          |           | chimh 沁  | cimh 浸  |          |         |           |         |          |          |           |          |    |     |          |         |
|----+----------+---------+--------+----+---------+---------+----------+----------+-----------+-----------+----------+----------+---------+-----------+---------+----------+----------+-----------+----------+----+-----+----------+---------|
|    |          |         |        |    |         |         |          |          |           |           |          |          |         |           |         |          |          |           |          |    |     |          |         |
|    |          |         |        |    |         |         |          | srip 澀  | zrip 霵   | chrip     | crip 戢  |          |         |           |         |          |          |           |          |    |     |          |         |
|    | njip 入  | lip 立  | ip 煜  |    | hip 吸  | qip 邑  | zjip 十  | sjip 濕  | zsjip     | chjip 斟  | cjip 執  | ngip 岌  | gip 及  | khip 泣   | kip 急  | nrip 孨  | drip 蟄  | thrip 湁  | trip 縶  |    | bip |          | pip 鵖  |
| 緝 |          |         | jip 熠 |    |         | qjip 揖 | zsip 習  | sip 卌   | zip 集    | chip 緝   | cip 潗   |          |         |           |         |          |          |           |          |    |     |          |         |
1. 〖孃〗母【侵】韻平聲替換为較常見的「您」；
2. 〖從〗母【侵】韻平聲替換为較常見的「埐」；
3. 〖生〗母【侵】韻上聲替換为較常見的「瘮」；
4. 〖莊〗母【侵】韻上聲替換为較常見的「怎」；
5. 〖谿〗母【侵】韻上聲替換为較常見的「顉」；
6. 〖群〗母【侵】韻去聲替換为較常見的「紟」；
7. 〖心〗母【緝】韻入聲替換为較常見的「卌」；
8. 〖精〗母【緝】韻入聲替換为氵旁的「潗」。
** 覃咸鹽添感豏琰忝勘陷豔合洽葉帖
*** 外轉第三十九開
|    |          | 來       |        | 匣        | 曉       | 影       |          | 心       | 從       | 清        | 精       | 疑        |          | 谿        | 見       | 泥       | 定       | 透         | 端       | 明      | 並 | 滂 | 幫       |
...
|    |          | 來       | 以     | 匣        | 曉       | 影       | 邪       | 心       | 從       | 清        | 精       | 疑        | 群       | 谿        | 見       | 泥       | 定       | 透         | 端       | 明      | 並 | 滂 | 幫       |
|----+----------+----------+--------+-----------+----------+----------+----------+----------+----------+-----------+----------+-----------+----------+-----------+----------+----------+----------+------------+----------+---------+----+----+----------|
| 覃 |          | lom 婪   |        | ghom 含   | hom 馠   | qom 諳   |          | som 毿   | zom 蠶   | chom 參   | com 簪   | ngom 嵁   |          | khom 龕   | kom 弇   | nom 南   | dom 覃   | thom 探    | tom 耽   |         |    |    |          |
| 咸 |          |          |        | ghrem 咸  | hrem 妗  | qrem 黯  |          | srem 櫼  | zrem 讒  |           |          | ngrem 嵒  |          | khrem 鵮  | krem 緘  | nrem 諵  |          |            | trem 詀  |         |    |    |          |
| 鹽 | njem 髯  | liem 廉  | iem 炎 |           |          | qiem 淹  | zjem 棎  | sjem 苫  |          | chjem 襜  | cjem 詹  | ngiem     | giem 鉗  |           | kiem     | nriem 黏 | driem 誗 | thriem 覘  | triem 霑 |         |    |    | piem 砭  |
| 添 |          | lem 鬑   |        | ghem 嫌   | hem 馦   |          |          | sem      |          |           | cem      |           |          | khem 謙   |          | nem 鮎   | dem 甜   | them 添    | tem 掂   |         |    |    |          |
|----+----------+----------+--------+-----------+----------+----------+----------+----------+----------+-----------+----------+-----------+----------+-----------+----------+----------+----------+------------+----------+---------+----+----+----------|
| 感 |          | lomx 壈  |        | ghomx 頷  | homx     | qomx 晻  |          | somx 糂  | zomx 歜  | chomx 慘  | comx 寁  | ngomx 顉  |          | khomx 坎  | komx 感  | nomx 腩  | domx 禫  | thomx 襑   | tomx 黕  |         |    |    |          |
| 豏 |          | lremx 臉 |        | ghremx 豏 | hremx 喊 | qremx 黯 |          | sremx 摻 | zremx 瀺 | chremx    | cremx 斬 | ngremx    |          | khremx 槏 | kremx 鹼 | nremx 淰 | dremx 湛 | thremx 旵  |          |         |    |    |          |
| 琰 | njemx 冉 | liemx 斂 |        | ghiemx    | hiemx 險 | qiemx 奄 | zjemx 剡 | sjemx 陝 |          |           | cjemx 颭 | ngiemx 顩 | giemx 儉 | khiemx 嵰 | kiemx 檢 |          |          | thriemx 諂 |          |         |    |    | piemx 貶 |
| 忝 |          | lemx 稴  |        |           |          |          |          |          |          | chemx 憯  |          |           |          | khemx 歉  | kemx 孂  | nemx 淰  | demx 簟  | themx 忝   | temx 點  | memx 厸 |    |    |          |
|----+----------+----------+--------+-----------+----------+----------+----------+----------+----------+-----------+----------+-----------+----------+-----------+----------+----------+----------+------------+----------+---------+----+----+----------|
| 勘 |          | lomh 顲  |        | ghomh 憾  | homh     | qomh 暗  |          | somh 俕  | zomh     | chomh 謲  | comh 篸  | ngomh 儑  |          | khomh 勘  | komh 紺  | nomh 妠  | domh 醰  | thomh 僋   | tomh 馾  |         |    |    |          |
| 陷 |          |          |        | ghremh 陷 | hremh    | qremh 韽 |          |          |          |           | cremh 蘸 | ngremh 顑 |          | khremh 歉 | kremh    | nremh 諵 | dremh 賺 |            | tremh 站 |         |    |    |          |
| 豔 | njemh 染 | liemh 殮 |        |           |          | qiemh    | zjemh 贍 | sjemh 閃 |          | chjemh 韂 | cjemh 占 | ngiemh 驗 |          |           |          |          |          | khiemh     |          |         |    |    | piemh 窆 |
| 掭 |          | lemh 稴  |        |           |          | qemh 酓  |          | semh     | zemh     |           | cemh 僭  |           |          | khemh 傔  | kemh 趝  | nemh 念  | demh 磹  | themh 掭   | temh 店  |         |    |    |          |
|----+----------+----------+--------+-----------+----------+----------+----------+----------+----------+-----------+----------+-----------+----------+-----------+----------+----------+----------+------------+----------+---------+----+----+----------|
| 合 |          | lop 拉   |        | ghop 合   | hop 欱   | qop 姶   |          | sop 趿   | zop 雜   | chop 遪   | cop 帀   | ngop 礏   |          | khop 溘   | kop 閤   | nop 納   | dop 沓   | thop 錔    | top 答   |         |    |    |          |
| 洽 |          |          |        | ghrep 洽  | hrep 敮  | qrep 凹  |          | srep 霎  | zrep 牐  | chrep 插  | crep 眨  | ngrep     |          | khrep 恰  | krep 夾  | nrep     | drep     | threp      | trep 劄  |         |    |    |          |
| 葉 | njep 讘  | liep 獵  | iep 瞱 |           | hiep     | qiep 腌  | zjep 涉  | sjep 攝  |          | chjep 謵  | cjep 讋  |           | giep 笈  | khiep     | kiep 鵖  | nriep 聶 | driep 殜 | thriep 锸  | triep 輒 |         |    |    |          |
| 帖 |          | lep      |        | ghep 協   | hep 偞   |          |          | sep 燮   | zep      | chep      | cep 浹   |           |          | khep 愜   | kep 頰   | nep 捻   | dep 牒   | thep 帖    | tep 聑   |         |    |    |          |
1. 〖曉〗母【覃】韻平聲替換为較常見的「馠」；
2. 〖疑〗母【覃】韻平聲替換为較常見的「嵁」；
3. 〖曉〗母【咸】韻平聲替換为較常見的「妗」；
4. 〖影〗母【咸】韻平聲替換为黑旁的「黯」；
5. 〖群〗母【鹽】韻平聲的「鉗」調整到三等；
6. 〖澄〗母【鹽】韻平聲替換为較常見的「誗」；
7. 〖端〗母【添】韻平聲替換为較常見的「掂」；
8. 〖疑〗母【覃】韻上聲替換为較常見的「顉」；
9. 〖谿〗母【咸】韻上聲替換为較常見的「槏」；
10. 〖孃〗母【咸】韻上聲替換为較常見的「淰」；
11. 〖徹〗母【咸】韻上聲替換为較常見的「旵」；
12. 〖谿〗母【鹽】韻上聲替換为較常見的「嵰」；
13. 〖明〗母【添】韻上聲替換为較常見的「厸」；
14. 加入〖澄〗母【咸】韻去聲的「賺」；
15. 〖知〗母【咸】韻去聲替換为較常見的「站」；
16. 〖昌〗母【鹽】韻去聲替換为革旁的「韂」；
17. 〖透〗母【添】韻去聲替換为扌旁的「掭」；
18. 〖清〗母【合】韻入聲替換为較常見的「遪」；
19. 〖疑〗母【合】韻入聲替換为較常見的「礏」；
20. 〖曉〗母【洽】韻入聲替換为較常見的「敮」；
21. 〖影〗母【洽】韻入聲替換为較常見的「凹」；
22. 〖崇〗母【洽】韻入聲替換为較常見的「牐」；
23. 〖初〗母【洽】韻入聲替換为較常見的「插」；
24. 〖影〗母【葉】韻入聲替換为較常見的「腌」；
25. 〖見〗母【葉】韻入聲替換为較常見的「鵖」；
26. 〖澄〗母【葉】韻入聲替換为歹旁的「殜」；
27. 〖曉〗母【帖】韻入聲的「偞」調整到四等。
** 談銜嚴鹽敢檻儼琰闞鑑釅豔盍狎業葉
*** 外轉第四十合
|    |    | 來      |         | 匣        | 曉       | 影       |          | 心       | 從       | 清        | 精       | 疑        |         | 谿        | 見       | 泥     | 定      | 透       | 端      | 明     | 並       | 滂 | 幫 |
|    |    | 來      |         | 匣        | 曉       | 影       | 俟       | 生       | 崇       | 初        | 莊       | 疑        |         | 谿        | 見       | 孃     | 澄      | 徹       | 知      | 明     | 並       | 滂 | 幫 |
...
|    |    | 來      | 以      | 匣        | 曉       | 影       | 邪       | 心       | 從       | 清        | 精       | 疑        | 群      | 谿        | 見       | 泥     | 定      | 透       | 端      | 明     | 並       | 滂 | 幫 |
|----+----+---------+---------+-----------+----------+----------+----------+----------+----------+-----------+----------+-----------+---------+-----------+----------+--------+---------+----------+---------+--------+----------+----+----|
| 談 |    | lam 藍  |         | gham 酣   | ham 蚶   | qam      |          | sam 三   | zam 慙   |           |          |           |         | kham 坩   | kam 甘   |        | dam 談  | tham 舑  | tam 擔  | mam 姏 |          |    |    |
| 銜 |    |         |         | ghram 銜  |          |          |          | sram 衫  | zram 巉  | chram 攙  |          | ngram 巖  |         | khram 嵌  | kram 監  |        |         |          |         |        | bram     |    |    |
| 嚴 |    |         |         |           | hiam 杴  | qiam 醃  |          |          |          |           |          | ngiam 嚴  | giam    | khiam 厱  |          |        |         |          |         |        |          |    |    |
| 鹽 |    |         | jem 鹽  |           |          | qjem 懕  | zsiem 燖 | siem 銛  | ziem 潛  | chiem 籤  | ciem 尖  |           |         |           |          |        |         |          |         |        |          |    |    |
|----+----+---------+---------+-----------+----------+----------+----------+----------+----------+-----------+----------+-----------+---------+-----------+----------+--------+---------+----------+---------+--------+----------+----+----|
| 敢 |    | lamx 覽 |         |           | hamx 喊  | qamx 埯  |          |          | zamx 槧  | chamx 黲  | camx     |           |         | khamx     | kamx 敢  |        | damx 噉 | thamx 菼 | tamx 膽 | mamx   |          |    |    |
| 檻 |    |         |         | ghramx 檻 | hramx 豃 | qramx 黤 |          | sramx    |          | chramx 醶 |          |           |         | khramx    |          |        |         |          |         |        |          |    |    |
| 儼 |    |         |         |           |          | qiamx 埯 |          | sjamx    |          |           |          | ngiamx 儼 |         |           |          |        |         |          |         |        |          |    |    |
| 琰 |    |         | jemx 琰 |           |          | qjemx 黶 |          |          | ziemx 漸 | chiemx 憸 |          |           |         |           |          |        |         |          |         |        |          |    |    |
|----+----+---------+---------+-----------+----------+----------+----------+----------+----------+-----------+----------+-----------+---------+-----------+----------+--------+---------+----------+---------+--------+----------+----+----|
| 闞 |    | lamh 濫 |         | ghamh 憨  | hamh 蘫  |          |          | samh 三  | zamh 暫  |           |          |           |         | khamh 闞  | kamh     |        | damh 氮 | thamh 賧 | tamh 擔 |        |          |    |    |
| 鑑 |    |         |         | ghramh    | hramh 譀 | qramh    |          | sramh 釤 | zramh 鑱 | chramh 懺 | cramh 覱 |           |         |           | kramh 鑑 |        |         |          |         |        | bramh 埿 |    |    |
| 釅 |    | liamh   |         |           | hiamh 脅 |          |          |          |          |           |          | ngiamh 釅 |         | khiamh 欠 | kiamh 劍 |        |         |          |         |        |          |    |    |
| 豔 |    | ljemh   | jemh 豔 |           |          | qjemh 厭 |          |          | ziemh 潛 | chiemh 壍 | ciemh    | ngjemh    |         |           |          |        |         |          |         |        |          |    |    |
|----+----+---------+---------+-----------+----------+----------+----------+----------+----------+-----------+----------+-----------+---------+-----------+----------+--------+---------+----------+---------+--------+----------+----+----|
| 盍 |    | lap 臘  |         | ghap 盍   | hap      | qap 鰪   |          | sap 仨   | zap      | chap 囃   |          | ngap 儑   |         | khap 榼   | kap 嗑   | nap 魶 | dap 蹋  | thap 塌  | tap 耷  |        |          |    |    |
| 狎 |    |         |         | ghrap 狎  | hrap 呷  | qrap 鴨  |          | srap 翣  |          |           |          |           |         |           | krap 甲  |        | drap    |          |         |        |          |    |    |
| 業 |    |         | iap     |           | hiap 脅  | qiap 腌  |          | sjap     |          |           |          | ngiap 業  | giap 跲 | khiap 怯  | kiap 劫  |        | driap   |          |         |        |          |    |    |
| 葉 |    |         | jep 葉  |           |          | qjep 魘  |          |          | ziep 捷  | chiep 妾  | ciep 接  |           |         |           |          |        |         |          |         |        |          |    |    |
1. 〖谿〗母【嚴】韻平聲替換为較常見的「厱」；
2. 〖精〗母【鹽】韻平聲替換为較常見的「尖」；
3. 〖曉〗母【銜】韻上聲替換为較常見的「豃」；
4. 〖曉〗母【談】韻去聲替換为較常見的「蘫」；
5. 〖定〗母【談】韻去聲替換为較常見的「氮」；
6. 〖曉〗母【銜】韻去聲替換为較常見的「譀」；
7. 〖谿〗母【嚴】韻去聲替換为較常見的「欠」；
8. 加入〖見〗母【嚴】韻去聲的「劍」；
9. 〖心〗母【盍】韻入聲替換为較常見的「仨」；
10. 〖見〗母【盍】韻入聲替換为較常見的「嗑」；
11. 〖定〗母【盍】韻入聲替換为較常見的「蹋」；
12. 〖端〗母【盍】韻入聲替換为較常見的「耷」。
** 凡范梵乏
*** 外轉第四十一合
|    |    | 來 |    | 匣 | 曉 | 影 |    | 心 | 從 | 清 | 精 | 疑     |    | 谿        | 見    | 泥    | 定 | 透      | 端    | 明       | 並       | 滂        | 幫      |
|    |    | 來 |    | 匣 | 曉 | 影 | 俟 | 生 | 崇 | 初 | 莊 | 疑     |    | 谿        | 見    | 孃    | 澄 | 徹      | 知    | 明       | 並       | 滂        | 幫      |
...
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
| 凡 |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       | myam     | byam 凡  | phyam     | pyam    |
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
|----+----+----+----+----+----+----+----+----+----+----+----+--------+----+-----------+-------+-------+----+---------+-------+----------+----------+-----------+---------|
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
| 范 |    |    |    |    |    |    |    |    |    |    |    | ngyamx |    | khyamx 凵 | kyamx |       |    | thryamx |       | myamx 錽 | byamx 范 | phyamx 釩 | pyamx   |
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
|----+----+----+----+----+----+----+----+----+----+----+----+--------+----+-----------+-------+-------+----+---------+-------+----------+----------+-----------+---------|
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
| 梵 |    |    |    |    |    |    |    |    |    |    |    |        |    | khyamh    | kyamh |       |    |         |       | myamh    | byamh 梵 | phyamh 汎 |         |
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
|----+----+----+----+----+----+----+----+----+----+----+----+--------+----+-----------+-------+-------+----+---------+-------+----------+----------+-----------+---------|
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
| 乏 |    |    |    |    |    |    |    |    |    |    |    |        |    | khyap 猲  |       | nryap |    |         | tryap |          | byap 乏  | phyap     | pyap 法 |
|    |    |    |    |    |    |    |    |    |    |    |    |        |    |           |       |       |    |         |       |          |          |           |         |
** 登蒸等拯嶝證德職
*** 內轉第四十二開
|    |           | 來      |         | 匣       | 曉       | 影       |           | 心        | 從         | 清         | 精        | 疑        |          | 谿        | 見       | 泥       | 定        | 透         | 端       | 明       | 並       | 滂        | 幫       |
...
|    |           | 來      | 以      | 匣       | 曉       | 影       | 邪        | 心        | 從         | 清         | 精        | 疑        | 群       | 谿        | 見       | 泥       | 定        | 透         | 端       | 明       | 並       | 滂        | 幫       |
|----+-----------+---------+---------+----------+----------+----------+-----------+-----------+------------+------------+-----------+-----------+----------+-----------+----------+----------+-----------+------------+----------+----------+----------+-----------+----------|
| 登 |           | long 楞 |         | ghong 恆 |          |          |           | song 僧   | zong 層    |            | cong 增   |           |          |           | kong 縆  | nong 能  | dong 騰   | thong 鼟   | tong 登  | mong 瞢  | bong 朋  | phong 漰  | pong 崩  |
|    |           |         |         |          |          |          |           | sring     | zring 磳   |            |           |           |          |           |          |          |           |            |          |          |          |           |          |
| 蒸 | njing 仍  | ling 陵 |         |          | hing 興  | qing 膺  | zjing 承  | sjing 升  | zsjing 繩  | chjing 稱  | cjing 蒸  | nging 凝  | ging 殑  | khing 硱  | king 兢  |          | dring 澄  | thring 僜  | tring 徵 |          | bing 凭  | phing 砯  | ping 冰  |
|    |           |         | jing 蠅 |          |          |          |           |           | zing 繒    |            |           |           |          |           |          |          |           |            |          |          |          |           |          |
|----+-----------+---------+---------+----------+----------+----------+-----------+-----------+------------+------------+-----------+-----------+----------+-----------+----------+----------+-----------+------------+----------+----------+----------+-----------+----------|
| 等 |           | longx   |         |          |          |          |           |           |            |            | congx     |           |          | khongx 肯 |          | nongx 能 |           |            | tongx 等 |          | bongx    | phongx 倗 |          |
|    |           |         |         |          |          |          |           |           |            |            |           |           |          |           |          |          |           |            |          |          |          |           |          |
| 拯 |           |         |         |          |          |          |           | sjingx    |            |            | cjingx 拯 |           | gingx 殑 | khingx    |          |          |           | thringx 庱 |          |          |          |           |          |
|    |           |         |         |          |          |          |           |           |            |            |           |           |          |           |          |          |           |            |          |          |          |           |          |
|----+-----------+---------+---------+----------+----------+----------+-----------+-----------+------------+------------+-----------+-----------+----------+-----------+----------+----------+-----------+------------+----------+----------+----------+-----------+----------|
| 嶝 |           |         |         |          |          |          |           | songh     | zongh 贈   | chongh 蹭  | congh 增  |           |          |           | kongh 亘 |          | dongh 鄧  | thongh     | tongh 嶝 | mongh 懜 | bongh 倗 |           | pongh 泵 |
|    |           |         |         |          |          |          |           |           |            |            |           |           |          |           |          |          |           |            |          |          |          |           |          |
| 證 | njingh 認 | lingh   |         |          | hingh 興 | qingh 應 | zjingh 丞 | sjingh 勝 | zsjingh 乘 | chjingh 稱 | cjingh 證 | ngingh 凝 | gingh 殑 |           |          |          | dringh 瞪 | thringh 覴 |          |          | bingh 凭 |           |          |
|    |           |         |         |          |          |          |           |           |            | chingh     | cingh 甑  |           |          |           |          |          |           |            |          |          |          |           |          |
|----+-----------+---------+---------+----------+----------+----------+-----------+-----------+------------+------------+-----------+-----------+----------+-----------+----------+----------+-----------+------------+----------+----------+----------+-----------+----------|
| 德 |           | lok 勒  |         | ghok 劾  | hok 黑   | qok 餩   |           | sok 塞    | zok 賊     | chok       | cok 則    |           |          | khok 刻   | kok 裓   | nok      | dok 特    | thok 忒    | tok 德   | mok 墨   | bok 菔   |           | pok 北   |
|    |           |         |         |          |          |          |           | srik 色   | zrik 崱    | chrik 測   | crik 稄   |           |          |           |          |          |           |            |          |          |          |           |          |
| 職 |           | lik 力  |         |          | hik 赩   | qik 憶   | zjik 寔   | sjik 識   | zsjik 食   | chjik 瀷   | cjik 職   | ngik 嶷   | gik 極   | khik      | kik 殛   | nrik 匿  | drik 直   | thrik 敕   | trik 陟  | mik      | bik 愎   | phik 愊   | pik 逼   |
|    |           |         | jik 弋  |          |          |          |           | sik 息    | zik 堲     |            | cik 即    |           |          |           |          |          |           |            | tik      |          |          |           |          |
1. 〖崇〗母【蒸】韻平聲替換为較常見的「磳」；
2. 〖以〗母【蒸】韻平聲的「蠅」調整到四等；
3. 〖幫〗母【登】韻去聲替換为較常見的「泵」；
4. 〖常〗母【蒸】韻去聲替換为較常見的「丞」。
*** 內轉第四十三合
|    |    | 來 |       | 匣        | 曉       | 影    |    | 心 | 從 | 清 | 精 | 疑 |    | 谿     | 見       | 泥 | 定 | 透 | 端 | 明 | 並 | 滂 | 幫 |
|    |    | 來 |       | 匣        | 曉       | 影    | 俟 | 生 | 崇 | 初 | 莊 | 疑 |    | 谿     | 見       | 孃 | 澄 | 徹 | 知 | 明 | 並 | 滂 | 幫 |
|    | 日 | 來 | 云    | 匣        | 曉       | 影    | 常 | 書 | 船 | 昌 | 章 | 疑 | 群 | 谿     | 見       | 孃 | 澄 | 徹 | 知 | 明 | 並 | 滂 | 幫 |
|    |    | 來 | 以    | 匣        | 曉       | 影    | 邪 | 心 | 從 | 清 | 精 | 疑 | 群 | 谿     | 見       | 泥 | 定 | 透 | 端 | 明 | 並 | 滂 | 幫 |
|----+----+----+-------+-----------+----------+-------+----+----+----+----+----+----+----+--------+----------+----+----+----+----+----+----+----+----|
| 登 |    |    |       | ghuong 弘 | huong 薨 | quong |    |    |    |    |    |    |    | khuong | kuong 肱 |    |    |    |    |    |    |    |    |
|    |    |    |       |           |          |       |    |    |    |    |    |    |    |        |          |    |    |    |    |    |    |    |    |
|    |    |    |       |           |          |       |    |    |    |    |    |    |    |        |          |    |    |    |    |    |    |    |    |
|    |    |    |       |           |          |       |    |    |    |    |    |    |    |        |          |    |    |    |    |    |    |    |    |
|----+----+----+-------+-----------+----------+-------+----+----+----+----+----+----+----+--------+----------+----+----+----+----+----+----+----+----|
